...
import static compiler.Scanner.Kind.AND;
import static compiler.Scanner.Kind.ARROW;
import static compiler.Scanner.Kind.ASSIGN;
import static compiler.Scanner.Kind.BARARROW;
import static compiler.Scanner.Kind.COMMA;
import static compiler.Scanner.Kind.DIV;
import static compiler.Scanner.Kind.EOF;
import static compiler.Scanner.Kind.EQUAL;
import static compiler.Scanner.Kind.GE;
import static compiler.Scanner.Kind.GT;
import static compiler.Scanner.Kind.IDENT;
import static compiler.Scanner.Kind.KW_HIDE;
import static compiler.Scanner.Kind.KW_IF;
import static compiler.Scanner.Kind.KW_MOVE;
import static compiler.Scanner.Kind.KW_SCALE;
import static compiler.Scanner.Kind.KW_SHOW;
import static compiler.Scanner.Kind.KW_WHILE;
import static compiler.Scanner.Kind.KW_XLOC;
import static compiler.Scanner.Kind.KW_YLOC;
import static compiler.Scanner.Kind.LBRACE;
import static compiler.Scanner.Kind.LE;
import static compiler.Scanner.Kind.LPAREN;
import static compiler.Scanner.Kind.LT;
import static compiler.Scanner.Kind.MINUS;
import static compiler.Scanner.Kind.MOD;
import static compiler.Scanner.Kind.NOTEQUAL;
import static compiler.Scanner.Kind.OP_BLUR;
import static compiler.Scanner.Kind.OP_CONVOLVE;
import static compiler.Scanner.Kind.OP_GRAY;
import static compiler.Scanner.Kind.OP_HEIGHT;
import static compiler.Scanner.Kind.OP_SLEEP;
import static compiler.Scanner.Kind.OP_WIDTH;
import static compiler.Scanner.Kind.OR;
import static compiler.Scanner.Kind.PLUS;
import static compiler.Scanner.Kind.RBRACE;
import static compiler.Scanner.Kind.RPAREN;
import static compiler.Scanner.Kind.SEMI;
import static compiler.Scanner.Kind.TIMES;
