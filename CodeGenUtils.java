...
//	}
	...
	public static void genPrint(boolean GEN, MethodVisitor mv, String message) {
		if(GEN){
//		mv.visitFieldInsn(Opcodes.GETSTATIC, "compiler/PLPRuntimeLog", "globalLog", "Lcompiler/PLPRuntimeLog;");
		mv.visitLdcInsn(message);
		mv.visitMethodInsn(Opcodes.INVOKESTATIC, "compiler/PLPRuntimeLog", "globalLogAddEntry", "(Ljava/lang/String;)V", false);
		}
	}	
	/**
